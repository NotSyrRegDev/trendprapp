...
<View className="mb-8 " >
<Text style={styles.textInput} className="block text-gray-700 font-bold mb-2" htmlFor="username">
    حرف السطر <Text className="text-red-500 text-base" > * </Text>  
</Text>
...
<View className="mb-8 " >
<Text style={styles.textInput} className="block text-gray-700 font-bold mb-2" htmlFor="username">
    عدد التذاكر في السطر <Text className="text-red-500 text-base" > * </Text>  
</Text>
...
<View className="mb-8 " >
    <Text style={styles.textInput} className="block text-gray-700 font-bold mb-2" htmlFor="username">
     فئة التذاكر <Text className="text-red-500 text-base" > * </Text>  
    </Text>
...
<View className="mb-8 " >
<Text style={styles.textInput} className="block text-gray-700 font-bold mb-2" htmlFor="username">
  سعر التذاكر في السطر <Text className="text-red-500 text-base" > * </Text>  
</Text>
...
<View className="mb-2 " >
<Text style={styles.textInput} className="block text-gray-700 font-bold mb-2" htmlFor="username">
 العرض الخاص بالتذكرة  <Text className="text-red-500 text-base" > * </Text>  
</Text>
...
<TouchableOpacity
      ...
      <TouchableOpacity
    className="text-white mt-2 mb-8 text-sm px-6 py-4 "
